...
locally} and {\em incrementally} at each node in the overlay path to the destination. The core routing concept is
prefix-based which is similar to the Classless InterDomain Routing (CIDR) routing architecture for the Internet \cite{}.
