...
the transport mechanism used in Picolo for node-node communication. Finally, we discuss how responsibility is delegates
to nodes, how Trust and Governance happens in Section \ref{net:gov}.
